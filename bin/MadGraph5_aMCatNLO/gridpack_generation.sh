...
make_tarball () {
    ...
    #else
    XZ_OPT="--lzma2=preset=9,dict=134MiB --memory=1536MiB"
    #fi
    ...
    echo XZ_OPT="$XZ_OPT" tar -cJpsf ${PRODHOME}/${name}_${scram_arch}_${cmssw_version}_tarball.tar.xz mgbasedir process runcmsgrid.sh gridpack_generation*.log InputCards $EXTRA_TAR_ARGS
